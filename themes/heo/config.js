const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-02-23', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '🧨欢迎来到玄学小站🧨', url: 'https://wushu.dpdns.org' },
    { title: '🔃请“刷新”获取最新内容🔃', url: 'https:///wushu.dpdns.org' },
    { title: '等待内容加载', url: 'https:///wushu.dpdns.org' },
  ...
  HEO_HERO_CATEGORY_2: { title: '☯️五术学习', url: 'https://wushu.dpdns.org/category/☯️五术' },
  ...
  HEO_SOCIAL_CARD_TITLE_3: '暂时没有>_<',
  HEO_SOCIAL_CARD_URL: 'https://wushu.dpdns.org',
